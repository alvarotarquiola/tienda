...
echo '
	<div id="login">		
		<form action="" method="post">
		  <div class="img-logo"> 
			  	<a href=""><img src="http://localhost/tienda/img/Carro.png" width="80" height="100"></a>
		  </div>
			<div class="page-title center" style="font-weight: bold;">'.translate('Forgot your password?').'</div><br />';
if (isset($confirmation))
	echo '	<br />
			<div style="font-weight: bold;">'.translate('Your password has been sent to your email.').'.</div>
			<div style="margin: 2em 0 0 0; text-align: right;"><a href="login.php?email='.Tools::safeOutput(Tools::getValue('email')).'">> '.translate('Back to the registration').'</a></div>';
else
	echo '	<span >'.translate('Please enter your email registration').' </span><br />
			<input type="text" name="email" class="input" /><br /><br />
			<div>
				<div id="send-password"><input type="submit" name="Submit" value="'.translate('Send').'" class="button" /></div>
				<div id="lost">&nbsp;</div>
			</div>
		</form>
	</div>
