...
class AdminCustomers extends AdminTab
{
	...
	public function viewcustomer()
	{
		...
		{
			echo '
			<table cellspacing="0" cellpadding="0" class="table" style="display:none">
				<tr>
	...
	public function displayForm($isMainTab = true)
	{
        ...
        $customerInf = new Customer($obj->id);
        $customerStats = $customerInf->getStats();
        
        
        $this->scriptCustomers();
		...
		'.($obj->id ? '<input type="hidden" name="id_'.$this->table.'" value="'.$obj->id.'" />' : '').'
			<fieldset>
				...
				//if (1 || isset($need_identifcation_number) AND $need_identifcation_number) 
				...
				<div class="margin-form">
					<input type="radio" name="active" id="active_on" value="1" disabled="disabled" '.($this->getFieldValue($obj, 'active') ? 'checked="checked" ' : '').'/>
					<label class="t" for="active_on"><img src="../img/admin/enabled.gif" alt="'.$this->l('Enabled').'" title="'.$this->l('Enabled').'" /></label>
					<input type="radio" name="active" id="active_off" value="0" disabled="disabled" '.(!$this->getFieldValue($obj, 'active') ? 'checked="checked" ' : '').'/>
					<label class="t" for="active_off"><img src="../img/admin/disabled.gif" alt="'.$this->l('Disabled').'" title="'.$this->l('Disabled').'" /></label>
					<p>'.$this->l('Allow or disallow this customer to log in').'</p>
				</div>
                <label>'.$this->l('Impuesto:').' </label>
				<div class="margin-form">
					<input type="radio" name="tax" id="tax_on" value="1" '.($this->getFieldValue($obj, 'tax') ? 'checked="checked" ' : '').'/>
					<label class="t" for="tax_on"><img src="../img/admin/enabled.gif" alt="'.$this->l('Enabled').'" title="'.$this->l('Enabled').'" /></label>
					<input type="radio" name="tax" id="tax_off" value="0" '.(!$this->getFieldValue($obj, 'tax') ? 'checked="checked" ' : '').'/>
					<label class="t" for="tax_off"><img src="../img/admin/disabled.gif" alt="'.$this->l('Disabled').'" title="'.$this->l('Disabled').'" /></label>
				</div>
				...
				<div class="margin-form" style="display:block;">
				...
				<div class="margin-form"  style="display:block;">';
					...
					{
						echo '
					<table id="selectCheckGroups" cellspacing="0" cellpadding="0" class="table" style="width: 29.5em;">
						<tr>
    ...
    public function scriptCustomers()
    {
        echo '
            <script type="text/javascript">
                ...
                jQuery(function(){
                    ...
                    $("#selectCheckGroups").on("click", ".groupBox", function(){
                        var elem = jQuery(this);
                        var inputCheck = elem.find("input[type=checkbox]");
                        $("#selectCheckGroups input[type=checkbox]").removeAttr("checked");
