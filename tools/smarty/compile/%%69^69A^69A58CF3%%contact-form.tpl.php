<?php /* Smarty version 2.6.20, created on 2010-11-18 10:43:27
         compiled from /home/qcpjuuzu/public_html/tienda/themes/Marron/contact-form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/home/qcpjuuzu/public_html/tienda/themes/Marron/contact-form.tpl', 1, false),array('modifier', 'escape', '/home/qcpjuuzu/public_html/tienda/themes/Marron/contact-form.tpl', 14, false),array('modifier', 'intval', '/home/qcpjuuzu/public_html/tienda/themes/Marron/contact-form.tpl', 22, false),array('modifier', 'stripslashes', '/home/qcpjuuzu/public_html/tienda/themes/Marron/contact-form.tpl', 33, false),)), $this); ?>
...
" <?php if (isset ( $_POST['id_contact'] ) && $_POST['id_contact'] == $this->_tpl_vars['contact']['id_contact']): ?>selected="selected"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['contact']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
			...
			<p id="desc_contact0" class="desc_contact"><label><?php echo smartyTranslate(array('s' => 'Select a subject'), $this);?>
</label></p>
		<?php $_from = $this->_tpl_vars['contacts']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['contact']):
?>
...
" class="desc_contact" style="display:none;">
			<label><?php echo smartyTranslate(array('s' => 'Description'), $this);?>
</label><span class="like_input"><?php echo ((is_array($_tmp=$this->_tpl_vars['contact']['description'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
</span></p>
		<?php endforeach; endif; unset($_from); ?>
		<p class="text">
			<label for="email"><?php echo smartyTranslate(array('s' => 'E-mail address'), $this);?>
</label>
			<input type="text" id="email" name="from" value="<?php if (isset ( $_POST['from'] )): ?><?php echo ((is_array($_tmp=((is_array($_tmp=$_POST['from'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')))) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
<?php endif; ?>" />
		</p>
		<p class="textarea">
