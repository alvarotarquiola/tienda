<?php /* Smarty version 2.6.20, created on 2013-04-03 18:23:54
         compiled from C:%5Cxampp%5Chtdocs%5Cjordi/themes/Rojo/shopping-cart.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', 'C:\\xampp\\htdocs\\jordi/themes/Rojo/shopping-cart.tpl', 7, false),array('function', 'displayPrice', 'C:\\xampp\\htdocs\\jordi/themes/Rojo/shopping-cart.tpl', 57, false),array('modifier', 'escape', 'C:\\xampp\\htdocs\\jordi/themes/Rojo/shopping-cart.tpl', 28, false),array('modifier', 'intval', 'C:\\xampp\\htdocs\\jordi/themes/Rojo/shopping-cart.tpl', 184, false),array('modifier', 'secureReferrer', 'C:\\xampp\\htdocs\\jordi/themes/Rojo/shopping-cart.tpl', 274, false),)), $this); ?>
...
<div id="order-detail-content" class="table_block">
	<table id="cart_summary" class="std">
		...
		<tfoot>
			<?php if ($this->_tpl_vars['use_taxes']): ?>
				<?php if ($this->_tpl_vars['priceDisplay']): ?>
					<tr class="cart_total_price">
						<td colspan="5"><?php echo smartyTranslate(array('s' => 'Total products (tax excl.):'), $this);?>
</td>
				...
				<?php else: ?>
					<tr class="cart_total_price">
						<td colspan="5"><?php echo smartyTranslate(array('s' => 'Total products (tax incl.):'), $this);?>
</td>
			...
			<?php else: ?>
				<tr class="cart_total_price">
					<td colspan="5"><?php echo smartyTranslate(array('s' => 'Total products:'), $this);?>
</td>
					<td class="price"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_products']), $this);?>
</td>
				</tr>
			...
			<?php if ($this->_tpl_vars['total_discounts'] != 0): ?>
				<?php if ($this->_tpl_vars['use_taxes']): ?>
					<?php if ($this->_tpl_vars['priceDisplay']): ?>
						<tr class="cart_total_voucher">
							<td colspan="5"><?php echo smartyTranslate(array('s' => 'Total vouchers (tax excl.):'), $this);?>
</td>
					...
					<?php else: ?>
						<tr class="cart_total_voucher">
							<td colspan="5"><?php echo smartyTranslate(array('s' => 'Total vouchers (tax incl.):'), $this);?>
</td>
				...
				<?php else: ?>
					<tr class="cart_total_voucher">
						<td colspan="5"><?php echo smartyTranslate(array('s' => 'Total vouchers:'), $this);?>
</td>
						<td class="price-discount"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_discounts_tax_exc']), $this);?>
</td>
					</tr>
			...
			<?php if ($this->_tpl_vars['total_wrapping'] > 0): ?>
				<?php if ($this->_tpl_vars['use_taxes']): ?>
					<?php if ($this->_tpl_vars['priceDisplay']): ?>
						<tr class="cart_total_voucher">
							<td colspan="5"><?php echo smartyTranslate(array('s' => 'Total gift-wrapping (tax excl.):'), $this);?>
</td>
					...
					<?php else: ?>
						<tr class="cart_total_voucher">
							<td colspan="5"><?php echo smartyTranslate(array('s' => 'Total gift-wrapping (tax incl.):'), $this);?>
</td>
				...
				<?php else: ?>
					<tr class="cart_total_voucher">
						<td colspan="5"><?php echo smartyTranslate(array('s' => 'Total gift-wrapping:'), $this);?>
</td>
						<td class="price-discount"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_wrapping_tax_exc']), $this);?>
</td>
					</tr>
			...
			<?php if ($this->_tpl_vars['shippingCost'] > 0): ?>
				<?php if ($this->_tpl_vars['use_taxes']): ?>
					<?php if ($this->_tpl_vars['priceDisplay']): ?>
						<tr class="cart_total_delivery">
							<td colspan="5"><?php echo smartyTranslate(array('s' => 'Total shipping (tax excl.):'), $this);?>
</td>
					...
					<?php else: ?>
						<tr class="cart_total_delivery">
							<td colspan="5"><?php echo smartyTranslate(array('s' => 'Total shipping (tax incl.):'), $this);?>
</td>
				...
				<?php else: ?>
					<tr class="cart_total_delivery">
						<td colspan="5"><?php echo smartyTranslate(array('s' => 'Total shipping:'), $this);?>
</td>
						<td class="price"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['shippingCostTaxExc']), $this);?>
</td>
					</tr>
			...
			<?php else: ?>
			<tr class="cart_total_price">
				<td colspan="5"><?php echo smartyTranslate(array('s' => 'Total:'), $this);?>
</td>
				<td class="price"><?php echo Tools::displayPriceSmarty(array('price' => $this->_tpl_vars['total_price_without_tax']), $this);?>
</td>
			</tr>
			...
			<tr class="cart_free_shipping">
				<td colspan="5" style="white-space: normal;"><?php echo smartyTranslate(array('s' => 'Remaining amount to be added to your cart in order to obtain free shipping:'), $this);?>
</td>
...
_small" alt="" class="customizationUploaded" width="<?php echo $this->_tpl_vars['smallSize']['width']; ?>
" height="<?php echo $this->_tpl_vars['smallSize']['height']; ?>
