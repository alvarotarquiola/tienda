<?php /* Smarty version 2.6.20, created on 2012-07-31 00:23:38
         compiled from /home/qcpjuuzu/public_html/Tienda-70/themes/Rojo/search.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/home/qcpjuuzu/public_html/Tienda-70/themes/Rojo/search.tpl', 1, false),array('modifier', 'escape', '/home/qcpjuuzu/public_html/Tienda-70/themes/Rojo/search.tpl', 4, false),array('modifier', 'intval', '/home/qcpjuuzu/public_html/Tienda-70/themes/Rojo/search.tpl', 19, false),)), $this); ?>
...
&nbsp;<?php if ($this->_tpl_vars['nbProducts'] > 0): ?>"<?php if ($this->_tpl_vars['search_query']): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['search_query'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
<?php elseif ($this->_tpl_vars['search_tag']): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['search_tag'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
...
"
		<?php elseif ($this->_tpl_vars['search_tag']): ?>
			<?php echo smartyTranslate(array('s' => 'No results found for your search'), $this);?>
