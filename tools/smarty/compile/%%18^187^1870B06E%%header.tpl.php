<?php /* Smarty version 2.6.20, created on 2010-11-12 12:09:18
         compiled from /home/qcpjuuzu/public_html/tienda/themes/moon/header.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/home/qcpjuuzu/public_html/tienda/themes/moon/header.tpl', 4, false),)), $this); ?>
...
;
		...
		<script type="text/javascript" src="<?php echo $this->_tpl_vars['content_dir']; ?>
themes/moon/js/boot.js"></script>
		<script type="text/javascript" src="<?php echo $this->_tpl_vars['content_dir']; ?>
themes/moon/js/boxes.js"></script>		
		<script type="text/javascript" src="<?php echo $this->_tpl_vars['content_dir']; ?>
...
logo.gif" alt="<?php echo ((is_array($_tmp=$this->_tpl_vars['shop_name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
" /></a></h1>
