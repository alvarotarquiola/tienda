<?php /* Smarty version 2.6.20, created on 2011-03-04 14:34:07
         compiled from /home/qcpjuuzu/public_html/tienda/themes/Marron/authentication.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/home/qcpjuuzu/public_html/tienda/themes/Marron/authentication.tpl', 1, false),array('modifier', 'intval', '/home/qcpjuuzu/public_html/tienda/themes/Marron/authentication.tpl', 6, false),array('modifier', 'escape', '/home/qcpjuuzu/public_html/tienda/themes/Marron/authentication.tpl', 12, false),array('modifier', 'stripslashes', '/home/qcpjuuzu/public_html/tienda/themes/Marron/authentication.tpl', 41, false),array('modifier', 'replace', '/home/qcpjuuzu/public_html/tienda/themes/Marron/authentication.tpl', 69, false),)), $this); ?>
...
.</h4>
				<p class="text">
					...
					<input type="text" id="email_create" name="email_create" value="<?php if (isset ( $_POST['email_create'] )): ?><?php echo ((is_array($_tmp=((is_array($_tmp=$_POST['email_create'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall') : smarty_modifier_escape($_tmp, 'htmlall')))) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
...
" method="post" id="login_form" class="std">
			<fieldset>
				...
				<h4><?php echo smartyTranslate(array('s' => 'Enter your e-mail address and password to access to your account'), $this);?>
.</h4>
				<p class="text">
