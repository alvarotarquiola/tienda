<?php /* Smarty version 2.6.20, created on 2012-05-28 12:46:12
         compiled from /var/www/vhosts/tuclicka.com/teamweb/tuning/themes/Rojo/order-detail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'l', '/var/www/vhosts/tuclicka.com/teamweb/tuning/themes/Rojo/order-detail.tpl', 1, false),array('function', 'dateFormat', '/var/www/vhosts/tuclicka.com/teamweb/tuning/themes/Rojo/order-detail.tpl', 1, false),array('function', 'displayWtPriceWithCurrency', '/var/www/vhosts/tuclicka.com/teamweb/tuning/themes/Rojo/order-detail.tpl', 93, false),array('function', 'convertPriceWithCurrency', '/var/www/vhosts/tuclicka.com/teamweb/tuning/themes/Rojo/order-detail.tpl', 142, false),array('function', 'counter', '/var/www/vhosts/tuclicka.com/teamweb/tuning/themes/Rojo/order-detail.tpl', 157, false),array('modifier', 'escape', '/var/www/vhosts/tuclicka.com/teamweb/tuning/themes/Rojo/order-detail.tpl', 17, false),array('modifier', 'string_format', '/var/www/vhosts/tuclicka.com/teamweb/tuning/themes/Rojo/order-detail.tpl', 30, false),array('modifier', 'intval', '/var/www/vhosts/tuclicka.com/teamweb/tuning/themes/Rojo/order-detail.tpl', 36, false),array('modifier', 'nl2br', '/var/www/vhosts/tuclicka.com/teamweb/tuning/themes/Rojo/order-detail.tpl', 51, false),array('modifier', 'cat', '/var/www/vhosts/tuclicka.com/teamweb/tuning/themes/Rojo/order-detail.tpl', 159, false),array('modifier', 'default', '/var/www/vhosts/tuclicka.com/teamweb/tuning/themes/Rojo/order-detail.tpl', 160, false),array('modifier', 'count', '/var/www/vhosts/tuclicka.com/teamweb/tuning/themes/Rojo/order-detail.tpl', 261, false),)), $this); ?>
...
<?php if ($this->_tpl_vars['pxc']): ?>
	<div class="bpagarorden">
	<a href="<?php echo $this->_tpl_vars['base_dir']; ?>
order.php?step=0&id_orderpay=<?php echo ((is_array($_tmp=$this->_tpl_vars['order']->id)) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
"><?php echo smartyTranslate(array('s' => 'Pagar Orden'), $this);?>
</a>
	</div>
<?php endif; ?>
...
<div id="order-detail-content" class="table_block">
	<table class="std">
		...
		<tfoot>
			<?php if ($this->_tpl_vars['priceDisplay'] && $this->_tpl_vars['use_tax']): ?>
				<tr class="item">
 ...
 <span class="price"><?php echo Product::displayWtPriceWithCurrency(array('price' => $this->_tpl_vars['order']->getTotalProductsWithoutTaxes(),'currency' => $this->_tpl_vars['currency'],'convert' => 0), $this);?>
			...
			<tr class="item">
				<td colspan="<?php if ($this->_tpl_vars['return_allowed']): ?>6<?php else: ?>5<?php endif; ?>">
					<?php echo smartyTranslate(array('s' => 'Total products'), $this);?>
 <?php if ($this->_tpl_vars['use_tax']): ?><?php echo smartyTranslate(array('s' => '(tax incl.)'), $this);?>
<?php endif; ?>: <span class="price"><?php echo Product::displayWtPriceWithCurrency(array('price' => $this->_tpl_vars['order']->getTotalProductsWithTaxes(),'currency' => $this->_tpl_vars['currency'],'convert' => 0), $this);?>
</span>
				</td>
			</tr>
 ...
 <span class="price-wrapping"><?php echo Product::displayWtPriceWithCurrency(array('price' => $this->_tpl_vars['order']->total_wrapping,'currency' => $this->_tpl_vars['currency'],'convert' => 0), $this);?>
			...
			<tr class="item">
				<td colspan="<?php if ($this->_tpl_vars['return_allowed']): ?>6<?php else: ?>5<?php endif; ?>">
					<?php echo smartyTranslate(array('s' => 'Total shipping'), $this);?>
 <?php if ($this->_tpl_vars['use_tax']): ?><?php echo smartyTranslate(array('s' => '(tax incl.)'), $this);?>
<?php endif; ?>: <span class="price-shipping"><?php echo Product::displayWtPriceWithCurrency(array('price' => $this->_tpl_vars['order']->total_shipping,'currency' => $this->_tpl_vars['currency'],'convert' => 0), $this);?>
</span>
				</td>
			</tr>
			<tr class="item">
...
_small" alt="" class="customizationUploaded" /></li>
    ...
    foreach ($_from as $this->_tpl_vars['data']):
?>
									<?php $this->assign('customizationFieldName', ((is_array($_tmp="Text #")) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['data']['id_customization_field']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['data']['id_customization_field']))); ?>
									<li><?php echo ((is_array($_tmp=@$this->_tpl_vars['data']['name'])) ? $this->_run_mod_handler('default', true, $_tmp, @$this->_tpl_vars['customizationFieldName']) : smarty_modifier_default($_tmp, @$this->_tpl_vars['customizationFieldName'])); ?>
