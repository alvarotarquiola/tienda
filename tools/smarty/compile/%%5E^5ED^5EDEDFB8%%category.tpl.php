<?php /* Smarty version 2.6.20, created on 2012-05-18 09:29:37
         compiled from /var/www/vhosts/tuclicka.com/teamweb/tuning/themes/Azul/category.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/var/www/vhosts/tuclicka.com/teamweb/tuning/themes/Azul/category.tpl', 6, false),array('function', 'l', '/var/www/vhosts/tuclicka.com/teamweb/tuning/themes/Azul/category.tpl', 8, false),)), $this); ?>
...
" id="categoryImage" />
	...
	<!-- Subcategories -->
	<?php echo $this->_tpl_vars['no_image']; ?>
...
?>
		<?php if (! $this->_tpl_vars['subcategory']['id_image'] || strpos ( $this->_tpl_vars['link']->getCatImageLink($this->_tpl_vars['subcategory']['link_rewrite'],$this->_tpl_vars['subcategory']['id_image'],'medium') , "default-medium.jpg" ) == 1): ?>
			<?php echo $this->_tpl_vars['no_image']; ?>
...
">
						<?php if ($this->_tpl_vars['subcategory']['id_image'] && strpos ( $this->_tpl_vars['link']->getCatImageLink($this->_tpl_vars['subcategory']['link_rewrite'],$this->_tpl_vars['subcategory']['id_image'],'medium') , "default-medium.jpg" ) == 0): ?>
