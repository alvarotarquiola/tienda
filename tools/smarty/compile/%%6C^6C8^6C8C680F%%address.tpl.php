<?php /* Smarty version 2.6.20, created on 2013-03-27 17:28:05
         compiled from C:%5Cxampp%5Chtdocs%5Cjordi/themes/Rojo/address.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'intval', 'C:\\xampp\\htdocs\\jordi/themes/Rojo/address.tpl', 22, false),array('modifier', 'escape', 'C:\\xampp\\htdocs\\jordi/themes/Rojo/address.tpl', 29, false),array('function', 'l', 'C:\\xampp\\htdocs\\jordi/themes/Rojo/address.tpl', 39, false),)), $this); ?>
...
<?php elseif (isset ( $this->_tpl_vars['address']->id_state )): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['address']->id_state)) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
...
?>
	<?php if (isset ( $this->_tpl_vars['country']['states'] ) && $this->_tpl_vars['country']['contains_states']): ?>
...
?>
			countries[<?php echo ((is_array($_tmp=$this->_tpl_vars['country']['id_country'])) ? $this->_run_mod_handler('intval', true, $_tmp) : intval($_tmp)); ?>
].push({'id' : '<?php echo $this->_tpl_vars['state']['id_state']; ?>
', 'name' : '<?php echo ((is_array($_tmp=$this->_tpl_vars['state']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'htmlall', 'UTF-8') : smarty_modifier_escape($_tmp, 'htmlall', 'UTF-8')); ?>
'});
...
<?php endif; ?>" />
		...
		<p class="required text" id="adress_alias">
            ...
            <label for="alias"><?php echo smartyTranslate(array('s' => 'Alias'), $this);?>
</label>
...
?step=1" /><?php endif; ?>
		<?php if (isset ( $this->_tpl_vars['mod'] )): ?><input type="hidden" name="mod" value="<?php echo $this->_tpl_vars['mod']; ?>
" /><?php endif; ?>
